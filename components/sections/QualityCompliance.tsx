...
export default function QualityCompliance() {
  return (
    <section
      className="section-y mx-auto overflow-hidden px-4 md:px-0"
    >
      <div className="flex flex-col-reverse md:flex-row gap-8">
        {/* Left image */}
        <div className="relative md:w-1/2 flex justify-end items-end bg-[#F9FAFB] rounded-[0_24px_24px_0] pt-16 md:pt-0">
          <p
            className="absolute top-5 right-5 md:top-10 md:right-10 bg-[#FFEE90] border-[#0D0C1D] text-[#0D0C1D]shadow-amber-100 px-1.5 py-1 md:px-3.5 md:py-2 rounded-full shadow-2xl text-sm md:text-base font-light tracking-wide not-last:backdrop-blur-sm border-t-[0.5px] border-l-[0.5px] border-r-2 border-b-2"
          >
            Intuitive User Interface
          </p>
          <div>
            <svg className="absolute top-15 right-15 md:top-25 md:right-25 w-12 h-12 md:w-[126px] md:h-[100px]" width="125" height="99" viewBox="0 0 125 99" fill="none">
          ...
          <div>
            <svg className="absolute top-10 md:top-16 ml-6 w-8 h-8 md:w-[50px] md:h-[49px]" width="50" height="49" viewBox="0 0 50 49" fill="none">
